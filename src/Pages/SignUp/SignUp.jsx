...
const SignUp = () => {
    const handleSignUp = async(event) =>{
        ...
        const signup_customar = "https://devcl.onrender.com/api/v1/auth_user/register/";
    
     
      await axios.post(signup_customar,
        usersignup)
            .then((response) => {
  ...
  <div className="hero-content flex justify-between lg:flex-row-reverse">
    <div className="card shrink-0 w-full max-w-sm shadow-2xl bg-white">
      <form onSubmit={handleSignUp} className="card-body">
        ...
        <h4 className='text-center font-bold text-2xl'>SignUp Customer</h4>
      ...
      <p className='text-center mb-4'><Link to='/sellersignup'>Become a Seller</Link>? <Link to='/'>Login</Link></p>
    </div>
